...
const Home = () => {
  ...
  <div className='md:h-screen md:w-full md:px-4 py-[80px] md:py-6 place-content-center'>
   <div className='flex flex-col md:flex-row items-center   md:gap-5 justify-between px-10'>
    ...
    <div className='scale-[60%] md:scale-[100%] flex flex-col items-center gap-4 px-[40px] md:px-20 rounded-full bg-secondary py-5 md:py-6 '>
