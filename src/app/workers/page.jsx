...
import { Eye, FilterIcon, ScanEye } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
const Workers = () => {
  ...
  return (
    <div className="w-full mx-auto mt-[20px] flex flex-col ">
      <div className="w-full flex  flex-wrap selection:flex-row items-center justify-between fixed top-0  z-30 bg-white border-b rounded-2xl px-[10%] py-3 shadow-md" >
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-20 pt-[20%] md:pt-[15%] z-0">
        {filteredMaids.map((maid) => (
          ...
          <CardHeader> 
            ...
            <CardTitle className='pt-[5%]'> <h2 className="card-title text-primary font-bold text-[20px]">{maid.name}</h2> </CardTitle>
            <CardDescription> <span className="text-primary text-[18px]">Price:</span>
                  <span className="ml-1">${maid.price}/Month</span></CardDescription>
          </CardHeader>
